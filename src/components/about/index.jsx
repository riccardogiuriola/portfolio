                    ...
                    <div class="grid grid-rows-1 gap-4 max-w-4xl">
                        <div class="grid grid-cols-8 gap-4 md:pl-20">
                            <div class="col-span-8">
                                <h1 class="text-3xl sm:text-3xl md:text-5xl lg:text-5xl font-bold w-full">About Me</h1>
                            ...
                            <figure class="w-3/6 m-auto md:m-0 lg:m-0 col-span-8 md:col-span-3 md:w-full lg:col-span-3 lg:w-full items-start justify-start profile-pic"><img className='rounded-lg' src="images/profile_pic.jpg" alt="Shoes" /></figure>
                        </div>
                    </div>
                </div>
            </div >
