                ...
                <div class="text-left hero-content">
                    <div class="grid grid-rows-1 gap-4 max-w-4xl">
                        <div class="grid grid-cols-8 gap-4 md:pl-20">
                            ...
                            <figure class="w-2/5 col-span-8 md:col-span-3 md:w-full lg:col-span-3 lg:w-full items-start justify-start profile-pic"><img className='rounded-lg' src="/images/profile_pic.jpg" alt="Shoes" /></figure>
                        </div>
                    </div>
                </div>
            </div >
